...
#                       url(r'^biomass/$', views.legacy.biomass, name='biomass'),
                       url(r'^biomass/$', views.core.BiomassList.as_view(), name='biomass'),
...
#                       url(r'^clone_newmedia/(?P<pk>\d+)/$', login_required(views.growth_data.CloneGrowthDataView.as_view()), name='clone_growth_data'),
                       ...
                       url(r'^newgrowthdata/$', login_required(views.growth_data.CreateGrowthDataView.as_view()), name='create_growth_data'),
#                       url(r'^editgrowthdata/$', login_required(views.growth_data.EditGrowthDataView.as_view()), name='edit_growth_data'),
