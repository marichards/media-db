...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'media_names', (
            ...
            ('media_name', self.gf('django.db.models.fields.CharField')(max_length=255L, db_column=u'Media_name')),
    ...
    models = {
        ...
        u'defined_media.medianames': {
            'Meta': {'object_name': 'MediaNames', 'db_table': "u'media_names'"},
            ...
            'media_name': ('django.db.models.fields.CharField', [], {'max_length': '255L', 'db_column': "u'Media_name'"}),
        ...
        u'defined_media.organisms': {
            'Meta': {'object_name': 'Organisms', 'db_table': "u'organisms'"},
            'genus': ('django.db.models.fields.CharField', [], {'max_length': '255L', 'db_column': "u'Genus'"}),
            'species': ('django.db.models.fields.CharField', [], {'max_length': '255L', 'db_column': "u'Species'"}),
        ...
        u'defined_media.sources': {
            'Meta': {'unique_together': "([u'first_author', u'journal', u'title'],)", 'object_name': 'Sources', 'db_table': "u'sources'"},
